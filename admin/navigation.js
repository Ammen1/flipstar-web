    ...
    items: [
      {
        ...
        label: 'Dashboard',
        description: 'Platform totals at a glance, with today’s movement on each.',
      },
      {
        id: 'analytics',
        icon: BarChart3,
    ...
    items: [
      {
        ...
        icon: Smartphone,
        label: 'Mobile App',
        description: 'Release versions, force-update rules and release notes.',
      },
      {
        id: 'judging',
        icon: Target,
        label: 'Judging Portal',
        description: 'Score campaign entries and record judging decisions.',
      },
      {
        id: 'reports',
        icon: Flag,
    ...
    items: [
      {
        ...
        icon: Users,
        label: 'Users',
        description: 'Search accounts, inspect activity and apply restrictions.',
      },
      {
        id: 'content',
        icon: FileVideo,
      ...
      },
      {
        ...
        description: 'Create the parent campaigns that sub-campaigns run under.',
      },
      {
        id: 'campaigns',
        icon: Award,
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: 'Packages, engagement costs and manual balance adjustments.',
      },
      {
