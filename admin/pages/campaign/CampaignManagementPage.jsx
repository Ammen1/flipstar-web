  ...
  return (
    <div>
      ...
      <div style={{
        ...
        <button
          onClick={() => {
            if (!selectedMasterCampaign) {
              alert('Please select a Master Campaign first to create a sub-campaign.');
              return;
            }
          ...
          style={{
            padding: '12px 24px',
            background: selectedMasterCampaign ? '#2563EB' : '#333333',
            border: 'none',
            borderRadius: 8,
            color: '#FFFFFF',
            fontSize: 14,
            ...
            opacity: selectedMasterCampaign ? 1 : 0.8,
          }}
        >
          <Plus size={16} />
          Create Campaign
              ...
              >
                ...
                <div style={{ padding: 20 }}>
                  ...
                  <div style={{ display: 'flex', gap: 8 }}>
                    ...
                    <button
                      onClick={() => onManageCampaign?.(campaign.id, 'leaderboard', campaign.campaign_type, campaign)}
                      style={{
                        flex: 1,
                        padding: '6px',
                        background: '#C8B56A15',
...
function CreateCampaignModal({ theme, onClose, onSuccess, selectedMasterCampaign }) {
  ...
  const [prizeType, setPrizeType] = useState('birr');
                ...
                <select
                  ...
                  onChange={(e) => {
                    ...
                    if (e.target.value === 'data') {
                      setFormData(f => ({ ...f, prize_value: '0', prize_title: f.prize_title || '1 GB Data' }));
                    } else {
                      setFormData(f => ({ ...f, prize_value: '' }));
                    }
                  }}
                  style={{
                    width: '100%',
