...
import { GenerationConfigModal } from '../../components/modal/GenerationConfigModal';
import { MasterCampaignLeaderboard } from '../../../pages/campaign/MasterCampaignLeaderboard';
...
export function MasterCampaignManagementPage({ theme }) {
  ...
  const [leaderboardCampaign, setLeaderboardCampaign] = useState(null);
  ...
  const handleViewLeaderboard = (campaign) => {
  ...
  return (
    <div>
      ...
      {/* Leaderboard Modal */}
      {showLeaderboard && leaderboardCampaign && (
        <div style={{
          position: 'fixed',
          top: 0,
          left: 0,
          ...
          <div style={{
            ...
            <MasterCampaignLeaderboard
              masterCampaignId={leaderboardCampaign.id}
              onBack={() => {
                setShowLeaderboard(false);
                setLeaderboardCampaign(null);
              }}
            />
          </div>
        </div>
